  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-3xl mx-auto bg-white shadow-lg rounded-2xl p-8">
        ...
        <p className="text-sm text-gray-600 mb-8">Last updated: June 2, 2025</p>

        <div className="space-y-6">
          <div>
            <p>
              TheraMind is basically a final year university project from
              University of Management and Technology Lahore. It is done by the
              three students: <strong>Abdullah Imran</strong>,{" "}
              <strong>Hamda Qadeer</strong> and <strong>Ambreen</strong>, and
              also operated by them.
            </p>
          </div>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                ...
                "We", "Us" or "Our" in this Agreement) refers to TheraMind.
              </li>
              <li>
