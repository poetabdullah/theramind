          ...
          <div className="space-y-6">
            <section>
              ...
              <p className="mb-4">
                ...
                before using our Service. By accessing or using TheraMind, you
              ...
              <p>
                ...
                Management and Technology Lahore. It is developed and operated
                by
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>
                  ...
                  “control” means ownership of 50% or more of the shares or
                  voting interest.
                </li>
                <li>
                ...
                <li>
                  ...
                  any service or content provided by a third party that may be
                  displayed, included, or made available via the Service.
                </li>
                <li>
                  <strong>Workspace API Data</strong> refers to any user data
                  accessed through Google Workspace APIs (such as Gmail,
                  Calendar, Drive, Docs) when the user authorizes TheraMind to
                  access their Workspace resources.
                </li>
                <li>
                  <strong>You</strong> means the individual or entity accessing
            ...
            <section>
              ...
              <p className="mb-4">
                These Terms govern your relationship with TheraMind. By using
                the Service, you agree to comply with these Terms in full. If
                you disagree with any part, you must not use the Service.
              </p>
              <p>
                You must be at least 16 years old to use this Service. We do not
                knowingly allow those under 16 to register or use TheraMind.
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                Google. During registration, we collect your name, email
                address, and profile picture. You grant us permission to access
                and store this information.
              </p>
              <p className="mb-4">
                When you schedule sessions or join meetings via TheraMind, we
                may request permission to access your Google Calendar (or other
                ...
                account settings, but revoking permissions may impair your
                ability to use certain Service features.
              </p>
              <p>
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                resources (e.g., Gmail, Calendar, Drive), we will access only
                the data strictly required to provide the Service features you
                request (such as generating a meeting link or retrieving your
                calendar events). We <strong>do not</strong> retain, aggregate,
                or use any Workspace API Data to develop, train, or improve any
                generalized AI or machine learning models outside the scope of
                your individual account usage.
              </p>
              <p className="mb-4">
              ...
              <p>
                ...
                this limited use. You may revoke this authorization at any time
                by disabling TheraMind’s access in your Google Account’s
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                the exclusive property of TheraMind or its licensors and are
              ...
              <p>
                ...
                download, store, or transmit any of the material except as
                follows:
              </p>
              <ul className="list-disc list-inside space-y-2 mt-2">
                ...
                <li>
                  ...
                  explicitly agree not to delete or alter any trademark, logo,
                  or copyright notice.
                </li>
                <li>
                  If we provide desktop, mobile, or other applications for
                  download, you may download a single copy to your device and
                  use it solely as permitted by the license agreement
                  accompanying such applications.
                </li>
              </ul>
              <p className="mt-4">
                Any other use of the materials is strictly prohibited. If you
                breach any provision of these Terms, your right to use the
                Service will automatically terminate.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>
                  Infringe or violate our intellectual property rights or those
                  of others.
                </li>
                <li>
                ...
                <li>
                  ...
                  Service, other accounts, or computer systems or networks
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                services not owned or controlled by the Company. We assume no
                responsibility for the content, privacy policies, or practices
                of those third-party sites. We recommend you review the terms
            ...
            <section>
              ...
              <p>
                ...
                right to use the Service will cease immediately. Sections which
                by their nature should survive termination will remain in
                effect.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                theory, even if TheraMind has been advised of the possibility of
                such damages.
              </p>
              <p>
                ...
                these Terms or your use of the Service is limited to the greater
                of (a) the total amount you have paid us in the twelve (12)
                months preceding the claim or (b) USD 100 if you have not paid
            ...
            <section>
              ...
              <p>
                ...
                TheraMind disclaims all warranties, express or implied,
                including but not limited to warranties of merchantability,
                fitness for a particular purpose, non-infringement, and
                availability. We do not warrant that the Service will be secure,
                error-free, uninterrupted, or that defects will be corrected.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                affect the remainder of these Terms, which will remain in full
                force and effect. The parties will negotiate in good faith to
                replace the invalid or unenforceable provision with a valid,
                enforceable provision that achieves, to the greatest extent
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                time. If we make material changes, we will notify you at least
                30 days prior to the changes taking effect by posting the
                updated Terms on the Service and updating the “Last updated”
                date. By continuing to use the Service after any changes become
