...
const MeditationHeader = () => {
  return (
    <header className="meditation-header relative bg-gradient-to-r from-purple-600 to-orange-500 py-12 md:py-20 px-4">
      {/* Animated Heading */}
      <motion.h1
        ...
        className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-white text-center mb-4 tracking-wide"
      >
      ...
      <motion.p
        ...
        className="mt-4 sm:mt-6 text-base sm:text-lg md:text-xl max-w-2xl mx-auto font-light text-white text-center"
      >
